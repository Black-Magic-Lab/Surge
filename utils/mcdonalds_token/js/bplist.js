require=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"kb58T/":[function(require,module,exports){
  ...
  var parseFile = exports.parseFile = function (arrayBuffer, callback) {
    function tryParseBuffer(arrayBuffer) {
      try {
        var result = parseBuffer(arrayBuffer);
    ...
    return tryParseBuffer(arrayBuffer);
  };
  
  var parseBuffer = exports.parseBuffer = function (arrayBuffer) {
    var result = {};
  
    var buffer = jDataView(arrayBuffer);
  
    // check header
    var header = buffer.slice(0, 'bplist'.length).getString();
    if (header !== 'bplist') {
      throw new Error("Invalid binary plist. Expected 'bplist' at offset 0.");
    }
  
    // Handle trailer, last 32 bytes of the file
    var trailer = buffer.slice(buffer.byteLength - 32, buffer.byteLength);
  
    // 6 null bytes (index 0 to 5)
    var offsetSize = trailer.getUint8(6);
    if (debug) {
      console.log("offsetSize: " + offsetSize);
    }
    var objectRefSize = trailer.getUint8(7);
    if (debug) {
      console.log("objectRefSize: " + objectRefSize);
    }
    var numObjects = trailer.getUint64(8, false);
    if (debug) {
      console.log("numObjects: " + numObjects);
    }
    var topObject = trailer.getUint64(16, false);
    if (debug) {
      console.log("topObject: " + topObject);
    }
    var offsetTableOffset = trailer.getUint64(24, false);
    if (debug) {
    ...
    function parseObject(tableOffset) {
      ...
      var type = buffer.getUint8(offset);
      ...
      function parseReal() {
        ...
        if (length < exports.maxObjectSize) {
          ...
          if (length === 4) {
            return realBuffer.getFloat32(0, false);
          }
          else if (length === 8) {
            return realBuffer.getFloat64(0, false);
          }
        } else {
          throw new Error("To little heap space available! Wanted to read " + length + " bytes, but only " + exports.maxObjectSize + " are available.");
        }
      ...
      function parseDate() {
        ...
        return new Date(EPOCH + (1000 * dateBuffer.getFloat64(0, false)));
      }
      ...
      function parsePlistString (isUtf16) {
        ...
        var stroffset = 1;
        if (objInfo == 0xF) {
          var int_type = buffer.getUint8(offset + 1);
          var intType = (int_type & 0xF0) / 0x10;
          if (intType != 0x1) {
        ...
        if (length < exports.maxObjectSize) {
          ...
          return plistString.getString(plistString.byteLength, 0, enc);
        } else {
          throw new Error("To little heap space available! Wanted to read " + length + " bytes, but only " + exports.maxObjectSize + " are available.");
        }
      }
  ...
  function swapBytes(buffer) {
    ...
    for (var i = 0; i < len; i += 2) {
      ...
      const b = buffer.getUint8(i+1);
      buffer.setUint8(i, b);
      buffer.setUint8(i+1, a);
    }
    return buffer;
  }
  
  }).call(this,require("buffer").Buffer)
  },{"buffer":3}],"bplistParser.js":[function(require,module,exports){
  module.exports=require('kb58T/');
